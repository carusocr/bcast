...
An auth.yml file containing Twitter API key data is required.
Example:
...
test_stream:
  ...
  o_tok:          '<access token>
  o_tok_sec:      '<access token secret>'
  a_meth:         '<authentication method, should be :oauth>'
...
#add lang specification to options?
